...
export const fileItemIcons = {
  ...
  document:<img src={require("../images/colored_icons/doc-icon.png")} alt="" />,
...
/*
  ...
  presentation: <img src={require("../images/colored_icons/ppt-icon.png")} alt="" />,
  script: <img src={require("../images/colored_icons/js-icon.png")} alt="" />,

  //site: <img src={require("../images/colored_icons/site-icon.png")} alt="" />,

  spreadsheet: <img src={require("../images/colored_icons/excel-icon.png")} alt="" />,
